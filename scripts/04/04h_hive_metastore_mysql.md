...
(if you want to use a local mysql installation, then change properties `javax.jdo.option.ConnectionURL`, `javax.jdo.option.ConnectionUserName` and `javax.jdo.option.ConnectionPassword`)
