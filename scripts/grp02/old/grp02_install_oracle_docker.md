...
# mkdir instantclient
# cd instantclient
# wget https://download.oracle.com/otn_software/linux/instantclient/23ai/instantclient-basic-linux.x64-23.3.0.0.0.zip
# wget https://download.oracle.com/otn_software/linux/instantclient/23ai/instantclient-sqlplus-linux.x64-23.3.0.0.0.zip
